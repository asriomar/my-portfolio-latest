...
const Hero = () => {
  ...
  const backgroundImageUrl = 'https://images.pexels.com/photos/924824/pexels-photo-924824.jpeg'; 
  ...
  return (
    ...
    >
      <div className="hero-content px-10 py-7 rounded-lg text-center  ">
        <img className='mb-2 ring-offset-2 ring-2 w-[128px] h-[128px]  md:w-[210px] md:h-[210px] hover:scale-105 cursor-pointer rounded-full mx-auto' src="profile-img.jpeg" alt="" />
